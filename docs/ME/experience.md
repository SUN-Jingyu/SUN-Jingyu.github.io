...
*海外平板业务安全模块支持（Android / BSP 驱动开发）* ｜ 2025.08 – 2025.11
...
<span id="Warwick_FYP">**华威大学微传感器与生物电子实验室（英国考文垂）**</span>  
...
- 系统架构展示 ![](./images_certification/RF_ASIC_chip.png)
...
<span id="UL_FYP">**RISC-V 两级流水 CPU FPGA 实现** </span>
...
- 海报 ![](./images_projects/毕设poster.png)
...
![](./images_certification/HPU院队足球.jpg)

- ☯️ 留学生太极表演

![](./images_certification/UL太极表演.JPG)

与导师和授课老师合照

![](./images_certification/UL表演与Conway.png){width=50%}
![](./images_certification/UL表演与Michael.png){width=43%}

- 中国驻爱尔兰大使交流

![](./images_certification/爱尔兰外交大使.JPG)

- 爱尔兰毕业舞会

![](./images_certification/UL晚会.JPG)